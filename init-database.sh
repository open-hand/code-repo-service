...
-Dinstaller.datasources.message.url="jdbc:mysql://localhost:3307/?useUnicode=true&characterEncoding=utf-8&useSSL=false&useInformationSchema=true&remarks=true" \
-Dinstaller.datasources.message.username=root \
-Dinstaller.datasources.message.password=root \
-Dinstaller.datasources.message.driver-class-name=com.mysql.jdbc.Driver \
-Ddata.init=true \
