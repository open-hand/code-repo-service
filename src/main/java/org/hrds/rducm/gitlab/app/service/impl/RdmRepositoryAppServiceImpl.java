...
import org.hrds.rducm.gitlab.infra.feign.DevOpsFeignClient;
...
public class RdmRepositoryAppServiceImpl implements RdmRepositoryAppService {
    ...
    public List<RdmRepository> listByActive(Long projectId) {
        ResponseEntity<List<AppServiceRepVO>> feignVO = devOpsFeignClient.listRepositoriesByActive(projectId);
