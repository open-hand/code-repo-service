...
public class CommitPayload {
    ...
    private List<org.gitlab4j.api.models.CommitAction> actions;
    ...
    public List<org.gitlab4j.api.models.CommitAction> getActions() {
        return actions;
    }

    public void setActions(List<org.gitlab4j.api.models.CommitAction> actions) {
        this.actions = actions;
    }

    public CommitPayload withActions(List<org.gitlab4j.api.models.CommitAction> actions) {
        this.actions = actions;
        return (this);
    }

    public CommitPayload withAction(org.gitlab4j.api.models.CommitAction action) {
    ...
    public CommitPayload withAction(org.gitlab4j.api.models.CommitAction.Action action, String filePath) {
	return (withAction(action, null, filePath));
    }

    public CommitPayload withAction(org.gitlab4j.api.models.CommitAction.Action action, String content, String filePath) {
	org.gitlab4j.api.models.CommitAction commitAction = new CommitAction()
	        .withAction(action)
	        .withContent(content)
